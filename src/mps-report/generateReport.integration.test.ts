...
describe("GenerateReport", () => {
  ...
  it("should generate report when errors are present in the table", async () => {
    let errorReport = readFileSync("src/mps-report/test/exampleAnnotatedMsg.xml", "utf8")
  ...
  it("should generate report when using record with multiple durations", async () => {
    let errorReport = readFileSync("src/mps-report/test/exampleMultipleDurationMsg.xml", "utf8")
